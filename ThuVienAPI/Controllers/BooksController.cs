...
namespace WebAPI_simple.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public IActionResult GetAll()
        {
            ...
            var allBooksDTO = allBooksDomain.Select(book => new Models.DTO.BookWithAuthorAndPublisherDTO()
            {
                Id = book.Id,
                Title = book.Title,
                ...
                AuthorNames = book.Book_Authors?.Select(ba => ba.Author.FullName).ToList() ?? new List<string>()
            }).ToList();
